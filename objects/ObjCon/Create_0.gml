...
charDesc[charName.acrobat,language.russian] = "Каждую ночь* вы выбираете игрока: если он пьян или отравлен сейчас или в течение ночи, вы умираете."
charTitle[charName.acrobat,language.english] = "Acrobat";
charDesc[charName.acrobat,language.english] = "Each night*, choose a player: if they are or become drunk or poisoned tonight, you die.";
charSet[charName.acrobat] = setName.experimental;
group[charName.acrobat] = charGroup.townsfolk;
...
charDesc[charName.alchemist,language.russian] = "У вас способность Приспешника. Когда вы используете её, Рассказчик может указать вам выбрать иначе."
charTitle[charName.alchemist,language.english] = "Alchemist";
charDesc[charName.alchemist,language.english] = "You have a Minion ability. When using this, the Storyteller may prompt you to choose differently.";
...
charDesc[charName.alhadikhia,language.russian] = "Каждую ночь*, вы можете выбрать 3 игроков (все узнают кого): каждый в тайне выбирает жить или умереть, но если все выбрали жить, все умирают."
charTitle[charName.alhadikhia,language.english] = "Al-Hadikhia";
charDesc[charName.alhadikhia,language.english] = "Each night*, you may choose 3 players (all players learn who): each silently chooses to live or die, but if all live, all die.";
...
charDesc[charName.balloonist,language.russian] = "Каждую ночь вы узнаёте игрока, у которого тип персонажа отличается от предыдущего показанного игрока. [+0 или +1 посторонний]"
charTitle[charName.balloonist,language.english] = "Balloonist";
charDesc[charName.balloonist,language.english] = "Each night, you learn a player of a different character type than last night. [+0 or +1 Outsider]";
...
charDesc[charName.boomdandy,language.russian] = "Если вас казнят, все кроме 3 игроков умирают. После отсчёта от 10 до 1, игрок на которого показывают больше всего игроков умирает."
charTitle[charName.boomdandy,language.english] = "Boomdandy";
charDesc[charName.boomdandy,language.english] = "If you are executed, all but 3 players die. After a 10 to 1 countdown, the player with the most players pointing at them, dies.";
...
charDesc[charName.cultleader,language.english] = "Each night, you become the alignment of an alive neighbor. If all good players choose to join your cult, your team wins.";
...
charDesc[charName.damsel,language.russian] = "Все приспешники знают, что в игре есть Мадам. Если приспешник публично угадает вас (один раз за игру), ваша команда проигрывает."
charTitle[charName.damsel,language.english] = "Damsel";
charDesc[charName.damsel,language.english] = "All Minions know a Damsel is in play. If a Minion publicly guesses you (once), your team loses.";
...
charDesc[charName.farmer,language.russian] = "Когда вы умираете ночью, живой Добрый игрок становится Фермером."
charTitle[charName.farmer,language.english] = "Farmer";
charDesc[charName.farmer,language.english] = "When you die at night, an alive good player becomes a Farmer.";
...
charDesc[charName.king,language.russian] = "Каждую ночь, если мёртвых столько же или больше, чем живых, вы узнаёте 1 персонажа живого игрока. Демон знает, что вы Король."
charTitle[charName.king,language.english] = "King";
charDesc[charName.king,language.english] = "Each night, if the dead equal or outnumber the living, you learn 1 alive character. The Demon knows you are the King.";
...
charDesc[charName.lilmonsta,language.russian] = "Каждую ночь Приспешники выбирают, кто из них нянчит Монстра Джуниора и \"является Демоном\". Игрок может умереть каждую ночь*. [+1 Приспешник]"
charTitle[charName.lilmonsta,language.english] = "Lil' Monsta";
charDesc[charName.lilmonsta,language.english] = "Each night, Minions choose who babysits Lil' Monsta & \"is the Demon\". Each night*, a player might die. [+1 Minion]"
...
charDesc[charName.lleech,language.russian] = "Каждую ночь* вы выбираете игрока: он умирает. В начале вы выбираете игрока: он отравлен. Вы умираете если (и только если) он мёртв."
charTitle[charName.lleech,language.english] = "Lleech";
charDesc[charName.lleech,language.english] = "Each night*, choose a player: they die. You start by choosing a player: they are poisoned. You die if & only if they are dead.";
...
charDesc[charName.lycanthrope,language.russian] = "Каждую ночь* вы выбираете живого игрока: если он Добрый, он умирает и Демон не убивает этой ночью. Один Добрый игрок считается Злым."
charTitle[charName.lycanthrope,language.english] = "Lycanthrope";
charDesc[charName.lycanthrope,language.english] = "Each night*, choose an alive player. If good, they die & the Demon doesn’t kill tonight. One good player registers as evil.";
...
charDesc[charName.nightwatchman,language.russian] = "Раз в игру, ночью, вы выбираете игрока: этот игрок узнаёт, что вы Ночной сторож."
charTitle[charName.nightwatchman,language.english] = "Nightwatchman";
charDesc[charName.nightwatchman,language.english] = "Once per game, at night, choose a player: they learn you are the Nightwatchman.";
...
charDesc[charName.riot,language.russian] = "На 3-ий день, Приспешники становятся Бунтом, а номинанты умирают и сразу же номинируют живого игрока."
charTitle[charName.riot,language.english] = "Riot";
charDesc[charName.riot,language.english] = "On day 3, Minions become Riot & nominees die but nominate an alive player immediately. This must happen.";
...
charDesc[charName.snitch,language.russian] = "Каждый Приспешник получает 3 блефа."
charTitle[charName.snitch,language.english] = "Snitch";
charDesc[charName.snitch,language.english] = "Each Minion gets 3 bluffs.";
...
charDesc[charName.organgrinder,language.russian] = "Все игроки голосуют с закрытыми глазами. Подсчёт голосов скрыт. Каждую ночь, вы выбираете пьяны вы или нет."
charTitle[charName.organgrinder,language.english] = "Organ Grinder";
charDesc[charName.organgrinder,language.english] = "All players keep their eyes closed when voting and the vote tally is secret. Each night, choose if you are drunk or not.";
...
charDesc[charName.vizier,language.russian] = "Все игроки знают, что вы Визирь. Вы не можете умереть днём. Если добрый игрок проголосовал, вы можете заставить сразу же казнить номинированного."
charTitle[charName.vizier,language.english] = "Vizier";
charDesc[charName.vizier,language.english] = "All players know you are the Vizier. You cannot die during the day. If good voted, you may choose to execute immediately.";
...
charDesc[charName.harpy,language.russian] = "Каждую ночь выберите 2 игроков: на следующий день первый игрок должен спятить, что второй - Злодей, иначе один из них или оба могут умереть."
charTitle[charName.harpy,language.english] = "Harpy";
charDesc[charName.harpy,language.english] = "Each night, choose 2 players: tomorrow, the 1st player is mad that the 2nd is evil, or one or both might die.";
...
charDesc[charName.plagueDoctor,language.russian] = "Когда вы умираете, Рассказчик получает способность Приспешника."
charTitle[charName.plagueDoctor,language.english] = "Plague Doctor";
charDesc[charName.plagueDoctor,language.english] = "When you die, the Storyteller gains a Minion ability.";
...
charCode[charName.alsaahir] = "alsaahir"
charIcon[charName.alsaahir] = SprAlsaahir
charTitle[charName.alsaahir,language.russian] = "Альсаахир"
charDesc[charName.alsaahir,language.russian] = "Каждый день, если вы публично угадаете какие игроки Приспешники, а какие Демоны, Добро побеждает."
charTitle[charName.alsaahir,language.english] = "Alsaahir";
charDesc[charName.alsaahir,language.english] = "Each day, if you publicly guess which players are Minion(s) and which are Demon(s), good wins.";
charSet[charName.alsaahir] = setName.experimental;
group[charName.alsaahir] = charGroup.townsfolk;
f_night[charName.alsaahir] = 0;
o_night[charName.alsaahir] = 32;
amy_order[charName.alsaahir] = amyOrder.dayActions;

charCode[charName.zealot] = "zealot"
charIcon[charName.zealot] = SprZealot
charTitle[charName.zealot,language.russian] = "Фанатик"
charDesc[charName.zealot,language.russian] = "Если 5+ игроков живы, вы должны голосовать за каждую номинацию."
charTitle[charName.zealot,language.english] = "Zealot";
charDesc[charName.zealot,language.english] = "If 5 or more players are alive, you must vote for every nomination.";
charSet[charName.zealot] = setName.experimental;
group[charName.zealot] = charGroup.outsider;
f_night[charName.zealot] = 0;
o_night[charName.zealot] = 32;
amy_order[charName.zealot] = amyOrder.passive;

charCode[charName.lord_of_typhoon] = "lord_of_typhon"
charIcon[charName.lord_of_typhoon] = SprLordOfTyphoon;
charTitle[charName.lord_of_typhoon,language.russian] = "Владыка Тифона"
charDesc[charName.lord_of_typhoon,language.russian] = "Каждую ночь*, вы выбираете игрока: он умирает. [Злые персонажи идут подряд. Вы в середине. +1 Приспешник. От -? до +? Посторонних]"
charTitle[charName.lord_of_typhoon,language.english] = "Lord of Typhon";
charDesc[charName.lord_of_typhoon,language.english] = "Each night*, choose a player: they die. [Evil characters are in a line. You are in the middle. +1 Minion. -? to +? Outsiders]";
charSet[charName.lord_of_typhoon] = setName.experimental;
group[charName.lord_of_typhoon] = charGroup.demon;
f_night[charName.lord_of_typhoon] = 0;
o_night[charName.lord_of_typhoon] = 32;
...
charDesc[charName.boffin,language.english] = "The Demon (even if drunk or poisoned) has a not-in-play good character's ability. You both know which.";
charSet[charName.boffin] = setName.experimental;
group[charName.boffin] = charGroup.minion;
f_night[charName.boffin] = 0;
o_night[charName.boffin] = 32;
...
charDesc[charName.xaan,language.english] = "On night X, all Townsfolk are poisoned until dusk. [X Outsiders]";
charSet[charName.xaan] = setName.experimental;
group[charName.xaan] = charGroup.minion;
f_night[charName.xaan] = 0;
o_night[charName.xaan] = 32;
...
charDesc[charName.wizard,language.english] = "Once per game, choose to make a wish. If granted, it might have a price & leave a clue as to its nature.";
charSet[charName.wizard] = setName.experimental;
group[charName.wizard] = charGroup.minion;
f_night[charName.wizard] = 0;
o_night[charName.wizard] = 32;
amy_order[charName.wizard] = amyOrder.passive;
...
travellerCode[travellerName.gnome] = "gnome"
travellerIcon[travellerName.gnome] = SprGnome
travellerTitle[travellerName.gnome,language.russian] = "Гном"
travellerDesc[travellerName.gnome,language.russian] = "Все игроки в начале знают игрока на вашей стороне. Вы можете убить любого, кто номинирует его."
travellerTitle[travellerName.gnome,language.english] = "Gnome"
travellerDesc[travellerName.gnome,language.english] = "All players start knowing a player of your alignment. You may choose to kill anyone who nominates them."
...
f_night_demon_info = 16;
f_night_minion_info = 13;
f_night_dawn_order = 70;
o_night_dawn_order = 90;
...
tag_filter_arr[0] = scr_make_array(charName.lord_of_typhoon,charName.xaan,charName.huntsman,charName.balloonist,charName.vigormortis,charName.fanggu,charName.godfather,charName.baron,charName.kazali);
...
tag_filter_arr[1] = scr_make_array(charName.zealot,charName.banshee,charName.organgrinder,charName.legion,charName.cultleader,charName.flowergirl,charName.butler);
...
tag_filter_arr[42] = scr_make_array(charName.boffin,charName.steward,charName.knight,charName.snitch,charName.pixie,charName.noble,charName.bountyhunter,charName.clockmaker,charName.grandmother,charName.godfather,charName.chef,charName.investigator,charName.librarian,charName.washerwoman,charName.shugenja);
...
tag_filter_arr[4] = scr_make_array(charName.alsaahir,charName.preacher,charName.engineer,charName.balloonist,charName.alchemist,charName.towncrier,charName.juggler,charName.minstrel,charName.investigator);
...
tag_filter_arr[5] = scr_make_array(charName.alsaahir,charName.knight,charName.puzzlemaster,charName.golem,charName.engineer,charName.choirboy,charName.balloonist,charName.snakecharmer,charName.sage,charName.juggler,charName.flowergirl,charName.exorcist,charName.fortuneteller,charName.slayer);
...
tag_filter_arr[6] = scr_make_array(charName.organgrinder,charName.puzzlemaster,charName.village_idiot,charName.acrobat,charName.sweetheart,charName.snakecharmer,charName.philosopher,charName.mathematician,charName.sailor,charName.minstrel,charName.innkeeper,charName.goon,charName.drunk,charName.courtier);
...
tag_filter_desc[13,language.russian] = "Используют посторонних для своих способностей, находят их, связаны с ними (необязательно посторонние и их счёт)";
...
tag_filter_arr[16] = scr_make_array(charName.wizard,charName.alchemist,charName.ojo,charName.village_idiot,charName.legion,charName.lilmonsta,charName.pithag,charName.amnesiac,charName.highPriestess,charName.general,charName.fisherman,charName.atheist,charName.tinker,charName.pacifist, charName.mayor, charName.recluse, charName.spy, charName.plagueDoctor, charName.shugenja);
...
tag_filter_arr[17] = scr_make_array(charName.xaan,charName.widow,charName.lleech,charName.cannibal,charName.acrobat,charName.vigormortis,charName.nodashii,charName.mathematician,charName.pukka,charName.poisoner);
...
tag_filter_arr[20] = scr_make_array(charName.lycanthrope,charName.poppygrower,charName.magician,charName.legion,charName.atheist,charName.zombuul, charName.recluse, charName.spy);
...
tag_filter_arr[21] = scr_make_array(charName.alsaahir,charName.riot,charName.politician,charName.leviathan,charName.heretic,charName.goblin,charName.fearmonger,charName.damsel,charName.cultleader,charName.atheist,charName.vortox,charName.klutz,charName.eviltwin,charName.mastermind,charName.mayor, charName.saint);
...
tag_filter_arr[23] = scr_make_array(charName.alsaahir,charName.zealot,charName.banshee,charName.psychopath,charName.yaggababble,charName.fisherman,charName.amnesiac,charName.savant,charName.juggler,charName.artist, charName.slayer, charName.gossip);
...
tag_filter_arr[25] = scr_make_array(charName.alsaahir,charName.banshee, charName.psychopath,charName.yaggababble,charName.vizier, charName.goblin,charName.damsel,charName.klutz,charName.juggler,charName.moonchild,charName.slayer,charName.gossip);
...
tag_filter_arr[35] = scr_make_array(charName.wizard,charName.yaggababble,charName.highPriestess,charName.mezepheles,charName.fisherman,charName.engineer,charName.atheist,charName.amnesiac,charName.alchemist,charName.artist,charName.gossip,charName.artist,charName.juggler);
...
tag_filter_arr[41] = scr_make_array(charName.boffin,charName.preacher,charName.pixie,charName.cannibal,charName.amnesiac,charName.alchemist,charName.vortox,charName.vigormortis,charName.philosopher,charName.plagueDoctor);
...
tag_filter_arr[43] = scr_make_array(charName.xaan,charName.lord_of_typhoon,charName.summoner, charName.kazali,charName.village_idiot,charName.huntsman,charName.balloonist,charName.vigormortis,charName.fanggu,charName.godfather,charName.baron,charName.marionette,charName.legion,charName.riot,charName.choirboy,charName.atheist,charName.bountyhunter,charName.lilmonsta);
...
scr_jynx(charName.cannibal,charName.poppygrower,"Если Каннибал съедает Маковода, а затем умирает или теряет способность Маковода, Демон и Приспешники знакомятся этой ночью.","If the Cannibal eats the Poppy Grower, then dies or loses the Poppy Grower ability, the Demon and Minions learn each other that night.");
...
scr_jynx(charName.summoner,charName.preacher,"Если Проповедник выбрал Призывателя до или в 3 ночь, Призыватель выбирает Демона, а Рассказчик игрока.","If the Preacher chose the Summoner on or before the 3rd night, the Summoner chooses which Demon, but the Storyteller chooses which player.");
//scr_jynx(charName.summoner,charName.,"","");

scr_jynx(charName.legion,charName.preacher,"Если Проповедник выбирает Легион, Легион оставляет способность, а Проповедник может узнать, что это Легион.","If the Preacher chooses Legion, Legion keeps their ability, but the Preacher might learn they are Legion.")
scr_jynx(charName.lilmonsta,charName.magician,"Каждую ночь, Фокусник выбирает Приспешника: если этот Приспешник и Монстр Джуниор в живых, этот Приспешник нянчит Монстра Джуниора.","Each night, the Magician chooses a Minion: if that Minion & Lil' Monsta are alive, that Minion babysits Lil’ Monsta.")
...
scr_jynx(charName.alhadikhia,charName.mastermind,"Если Аль-Хадика умирает от казни и Руководитель в живых, Аль-Хадика выбирает 3 игроков ночью. Если все выбирают жить - Зло побеждает, если нет - Добро.","If the Al-Hadikhia dies by execution, and the Mastermind is alive, the Al-Hadikhia chooses 3 good players tonight: if all 3 choose to live, evil wins. Otherwise, good wins.")
...
scr_jynx(charName.minstrel,charName.legion,"Если Легион умер от казни днём, Легион оставляет способность, а Менестрель может узнать что это Легион.","If Legion died by execution today, Legion keeps their ability, but the Minstrel might learn they are Legion.")
...
scr_jynx(charName.marionette,charName.balloonist,"Если Марионетка думает, что она Аэронавт, может добавиться +1 Посторонний","If the Marionette thinks that they are the Balloonist, +1 Outsider might have been added")
scr_jynx(charName.marionette,charName.huntsman,"Если Марионетка думает, что она Охотник, +Мадам","If the Marionette thinks that they are the Huntsman, the Damsel was added")
...
scr_jynx(charName.leviathan,charName.exorcist,"Зло не побеждает от казни Добрых, если Экзорцист жив и когда-либо выбирал Левиафана.","Evil does not win when more than 1 good player has been executed, if the Exorcist is alive and has ever successfully chosen the Leviathan.");
scr_jynx(charName.leviathan,charName.king,"Если в игре Левиафан и хотя бы 1 игрок мёртв, Король узнаёт живого персонажа каждую ночь.","If the Leviathan is in play, and at least 1 player is dead, the King learns an alive character each night.");
scr_jynx(charName.leviathan,charName.grandmother,"Если в игре Левиафан и внучок умирает, Зло побеждает.","If Leviathan is in play and the Grandchild dies by execution, evil wins.");
scr_jynx(charName.leviathan,charName.soldier,"Если Левиафан в игре, Солдату не могут навредить никакие Злые способности.","If the Leviathan is in play, the Soldier is safe from all evil abilities.");
scr_jynx(charName.leviathan,charName.monk,"Если в игре Левиафан, защита Монаха защищает от всех Злых способностей.","If the Leviathan is in play, the Monk-protected-player is safe from all evil abilities.");
scr_jynx(charName.leviathan,charName.innkeeper,"Если в игре Левиафан, защита Трактирщика защищает от всех Злых способностей.","If the Leviathan is in play, the Innkeeper-protected-players are safe from all evil abilities.");
scr_jynx(charName.leviathan,charName.ravenkeeper,"Каждую ночь*, Левиафан выбирает живого Доброго игрока (нельзя повторяться): выбранный Хозяин Ворона использует способность, но не умирает.","Each night*, the Leviathan chooses an alive player (different to previous nights): a chosen Ravenkeeper uses their ability but does not die.");
scr_jynx(charName.leviathan,charName.sage,"Каждую ночь*, Левиафан выбирает живого Доброго игрока (нельзя повторяться): выбранный Мудрец использует способность, но не умирает ","Each night*, the Leviathan chooses an alive good player (different to previous nights): a chosen Sage uses their ability but does not die.");
...
scr_jynx(charName.leviathan,charName.farmer,"Каждую ночь*, Левиафан выбирает живого Доброго игрока (нельзя повторяться): выбранный Фермер срабатывает, но остаётся в живых.","Each night*, the Leviathan chooses an alive good player (different to previous nights): a chosen Farmer uses their ability but does not die.");
scr_jynx(charName.leviathan,charName.banshee,"Каждую ночь*, Левиафан выбирает живого Доброго игрока (нельзя повторяться): выбранная Банши умирает и получает свою способность.","Each night*, the Leviathan chooses an alive good player (different to previous nights): a chosen Banshee dies & gains their ability.");
scr_jynx(charName.leviathan,charName.hatter,"Если Шляпник умер на 5 день или после него, Демон не может выбрать Левиафана.","If the Hatter dies on or after day 5, the Demon cannot choose Leviathan.");
...
scr_jynx(charName.riot,charName.exorcist,"Если Экзорцист выбирает Бунт на 3-ю ночь, Приспешники не становятся Бунтом.","If the Exorcist chooses Riot on the 3rd night, Minions do not become Riot.")
scr_jynx(charName.riot,charName.grandmother,"Если в игре Бунт и внучок умирает днём, Бабушка тоже умирает.","If Riot is in play and the Grandchild dies during the day, the Grandmother dies too.")
scr_jynx(charName.riot,charName.king,"Если Бунт в игре и хотя бы 1 игрок мёртв, Король узнаёт живого персонажа каждую ночь.","If Riot is in play, and at least 1 player is dead, the King learns an alive character each night.")
scr_jynx(charName.riot,charName.sage,"Каждую ночь*, Бунт выбирает живого Доброго игрока (нельзя повторяться): выбранный Мудрец срабатывает, но не умирает.","Each night*, Riot chooses an alive good player (different to previous nights): a chosen Sage uses their ability but does not die.")
scr_jynx(charName.riot,charName.ravenkeeper,"Каждую ночь*, Бунт выбирает живого Доброго игрока (нельзя повторяться): выбранный Хозяин Ворона срабатывает, но не умирает.","Each night*, Riot chooses an alive good player (different to previous nights): a chosen Ravenkeeper uses their ability but does not die.")
scr_jynx(charName.riot,charName.farmer,"Каждую ночь*, Бунт выбирает живого Доброго игрока (нельзя повторяться): выбранный Фермер срабатывает, но не умирает.","If a Riot player nominates and kills a Farmer, the Farmer uses their ability tonight")
scr_jynx(charName.riot,charName.soldier,"Если Бунт в игре, Солдату не могут навредить Злые способности.","If Riot is in play, the Soldier is safe from all evil abilities.")
scr_jynx(charName.riot,charName.innkeeper,"Если в игре Бунт, защищённые Трактирщиком игроки защищены от всех Злых способностей.","If Riot is in play, the Innkeeper-protected player is safe from all evil abilities.")
scr_jynx(charName.riot,charName.monk,"Если в игре Бунт, защищённые Монахом игроки защищены от всех Злых способностей.","If Riot is in play, the Monk-protected player is safe from all evil abilities.")
scr_jynx(charName.riot,charName.mayor,"Мэр может решить прекратить номинации. Если он это сделал и в живых 1 Бунт, Добро побеждает. Иначе побеждает Зло.","The Mayor may choose to stop nominations. If they do so when only 1 Riot is alive, good wins. Otherwise, evil wins.")
scr_jynx(charName.riot,charName.banshee,"Каждую ночь*, Бунт выбирает живого Доброго игрока (нельзя повторяться): выбранная Банши умирает и получает свою способность.","Each night*, Riot chooses an alive good player (different to previous nights): a chosen Banshee dies & gains their ability.")
...
scr_jynx(charName.vizier,charName.alsaahir,"Если Визирь в игре, Альсаахир должен также угадать какой Демон(ы) в игре.","If the Vizier is in play, the Alsaahir must also guess which Demon(s) are in play.");
...
scr_jynx(charName.kazali,charName.goon,"Казали может завербовать Солдата в своего Злого Приспешника.","The Kazali can choose that the Goon player is one of their evil Minions.");
...
scr_jynx(charName.kazali,charName.soldier,"Казали может завербовать Солдата в своего Злого Приспешника.","The Kazali can choose that the Soldier player is one of their evil Minions.");
